...
ETCDIR=$(DESTDIR)/$(PREFIX)/etc/libextl
# Some .lua files and ion-* shell scripts
SHAREDIR=$(DESTDIR)/$(PREFIX)/share/libextl
# Manual pages
MANDIR=$(DESTDIR)/$(PREFIX)/share/man
# Some documents
DOCDIR=$(DESTDIR)/$(PREFIX)/share/doc/libextl
# Nothing at the moment
INCDIR=$(DESTDIR)/$(PREFIX)/include/libextl
# Nothing at the moment
LIBDIR=$(DESTDIR)/$(PREFIX)/lib
# Modules
MODULEDIR=$(DESTDIR)/$(PREFIX)/lib/libextl/mod
# Compiled Lua source code
LCDIR=$(DESTDIR)/$(PREFIX)/lib/libextl/lc
# ion-completefile (does not belong in SHAREDIR being a binary file)
EXTRABINDIR=$(DESTDIR)/$(PREFIX)/lib/libextl/bin
# For ion-completeman system-wide cache
VARDIR=$(DESTDIR)/var/cache/libextl
# Message catalogs
